...
export const register = async (req, res) => {
    const { name, lastname, username, birthdate, phone_number, email, password, role, licenseNumber } = req.body;
    ...
    try {
        ...
        const newUser = new User({
            ...
            role,
            licenseNumber: role === 'doctor' ? licenseNumber : undefined, // Solo agregar licenseNumber si el rol es doctor
        });
